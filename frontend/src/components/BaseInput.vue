  ...
  <div class="w-full">
    ...
    <div class="relative">
      <input
        ...
        :maxlength="maxlength"
        :class="[
          'w-full px-4 py-3 border rounded-lg text-twitter-black placeholder-twitter-dark-gray transition-colors',
        ...
        @focus="$emit('focus')"
      />
      <span v-if="maxlength && showCounter" class="absolute right-3 top-3 text-sm text-twitter-dark-gray">
